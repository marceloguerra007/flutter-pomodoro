              ...
              builder: (_) => Row(
                ...
                children: [
                  TimeInput(
                    ...
                    inc: store.started && store.isWorking() ? null : store.incrementWorkTime,
                    dec: store.started && store.isWorking() ? null : store.decrementWorkTime,
                  ),
                  TimeInput(
                    title: 'Descanso', 
                    ...
                    dec: store.started && store.isResting() ? null : store.decrementRestTime,
                  )
                ],
              ),
            )
